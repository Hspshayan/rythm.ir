console.log(`Welcome to SERVICE HANDLER /--/ By Arvin /--/ Discord: 𝒜𝓇𝓋𝒾𝓃#3413`.yellow);
...
module.exports = (client) => {
    ...
    client.distube
      ...
      .on(`addSong`, (queue, song) => queue.textChannel.send({
        embeds: [
          ...
          .setTitle(`now playing ${newTrack.name}`)
  ...
  function receiveQueueData(newQueue, newTrack) {
    ...
    var embed = new MessageEmbed().setColor(ee.color)
      .setDescription(`See the [Queue on the **DASHBOARD** Live!](https://a-music.arvinkh20.repl.co/queue/${newQueue.id})`)
      ...
      .addField(`↪️ Autoplay:`, `>>> ${newQueue.autoplay ? `${client.allEmojis.check_mark}` : `${client.allEmojis.x}`}`, true)
      	.addField(`⏺ Video link:`, `>>> [\`Click here\`](${newTrack.url})`, true)
