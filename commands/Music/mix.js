	...
	run: async (client, message, args) => {
		try {
			...
			if (args[0]) {
				...
				if (args[0].toLowerCase().startsWith("1")) link = "https://www.uplooder.net/f/tl/6/7cc5cb1ac95c318668e2ea8472ef606c/Dj-Ra_s_s-podcast-in-the-house-persian-mix.mp3";
				//pop
				if (args[0].toLowerCase().startsWith("2")) link = "https://www.youtube.com/watch?v=eCz7PkAJnn4&t=3s";
				//default
